...
from ..ui.parsing_wizard_window import ParsingWizardUi
...
class ParsingWizard:
    ...
    def read_tasks(self):
        ...
        for file in files:
            ...
            task_name = settings.value('task_name')
    ...
    def add_task(self, task):
        ...
        Args:
            task: словарь с ключами name - имя задачи, links - список ссылок для парсинга(строки).
        """
